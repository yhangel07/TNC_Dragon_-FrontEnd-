...
var BranchPage = /** @class */ (function () {
    function BranchPage(route, geolocation, alertController, navCtrl, http, pickerCtrl, branchesList) {
        this.route = route;
    ...
    BranchPage.prototype.ngOnInit = function () {
        ...
        this.route.queryParams
            .filter(function (params) { return params.brandName; })
            .subscribe(function (params) {
            _this.brand = params.brandName;
            _this.id = params.id;
        });
        this.initializeMap();
                    ...
                    case 1:
                        ...
                        this.branchesList.getRawBranches()
                            ...
                            _this.branch_list.forEach(function (branch) {
                                ...
                                }).on('click', _this.branchInfo.bind(_this, branch));
    ...
    BranchPage.prototype.branchInfo = function (marker, name) {
        console.log(marker);
        console.log(name);
    };
    ;
