...
var BranchListPage = /** @class */ (function () {
    function BranchListPage(navCtrl, branchesList, branchList, photoViewer) {
    ...
    BranchListPage.prototype.branchesOrderBy = function (prop) {
        return this.branches.sort(function (a, b) { return a[prop] > b[prop] ? 1 : a[prop] === b[prop] ? 0 : -1; });
    };
    ...
    BranchListPage.prototype.viewPhoto = function (branch) {
        this.photoViewer.show(branch.img, branch.branch_name + ' image', { share: true });
    };
...
//# sourceMappingURL=branch-branch-list-module-es5.js.map